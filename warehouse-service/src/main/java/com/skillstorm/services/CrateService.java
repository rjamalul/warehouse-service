...
public class CrateService {
	...
	public Crate checkIfMaxCapacityIsHit(String type, Crate newCrate) {
		...
		if (warehouse.getCurrentCapacity() + newCrate.getCrateSize() < warehouse.getMaxCapacity() || (type.equalsIgnoreCase("update") && ((warehouse.getCurrentCapacity() - oldCrate.getCrateSize() + newCrate.getCrateSize()) < warehouse.getMaxCapacity()))) {
